...
RL_Sim::RL_Sim(int argc, char **argv)
{
    ...
    this->depth_subscriber = nh.subscribe<std_msgs::Float32MultiArray>("/forward_depth_image", 1, &RL_Sim::DepthCallback, this);
...
int main(int argc, char **argv)
{
    ...
    RL_Sim rl_itri(argc, argv);
    ros::spin();
#elif defined(USE_ROS2)
    rclcpp::init(argc, argv);
    auto rl_itri = std::make_shared<RL_Sim>(argc, argv);
