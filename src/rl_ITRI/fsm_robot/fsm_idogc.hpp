...
#ifndef IDOGC_FSM_HPP
#define IDOGC_FSM_HPP
...
class IdogcFSMFactory : public FSMFactory
{
public:
    IdogcFSMFactory(const std::string& initial) : initial_state_(initial) {}
    std::shared_ptr<FSMState> CreateState(void *context, const std::string &state_name) override
    {
        RL *rl = static_cast<RL *>(context);
        if (state_name == "RLFSMStatePassive")
            return std::make_shared<idogc_fsm::RLFSMStatePassive>(rl);
        else if (state_name == "RLFSMStateGetUp")
            return std::make_shared<idogc_fsm::RLFSMStateGetUp>(rl);
        else if (state_name == "RLFSMStateGetDown")
            return std::make_shared<idogc_fsm::RLFSMStateGetDown>(rl);
        else if (state_name == "RLFSMStateRLLocomotion")
            return std::make_shared<idogc_fsm::RLFSMStateRLLocomotion>(rl);
        else if (state_name == "RLFSMStateRLRobotLabLocomotion")
            return std::make_shared<idogc_fsm::RLFSMStateRLRobotLabLocomotion>(rl);
        else if (state_name == "RLFSMStateRLExtremeParkourLocomotion")
            return std::make_shared<idogc_fsm::RLFSMStateRLExtremeParkourLocomotion>(rl);
        return nullptr;
    }
    std::string GetType() const override { return "idogc"; }
...
REGISTER_FSM_FACTORY(IdogcFSMFactory, "RLFSMStatePassive")
